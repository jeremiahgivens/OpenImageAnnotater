...
class Ui_SettingsWidget(object):
    def setupUi(self, SettingsWidget):
        ...
        self.totImages = QtWidgets.QLabel(parent=SettingsWidget)
        self.totImages.setObjectName("totImages")
        self.verticalLayout_6.addWidget(self.totImages)
        self.labeledImages = QtWidgets.QLabel(parent=SettingsWidget)
        self.labeledImages.setObjectName("labeledImages")
        self.verticalLayout_6.addWidget(self.labeledImages)
        self.unlabeled = QtWidgets.QLabel(parent=SettingsWidget)
        self.unlabeled.setObjectName("unlabeled")
        self.verticalLayout_6.addWidget(self.unlabeled)
        ...
        self.trainSlider = QtWidgets.QSlider(parent=SettingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.trainSlider.sizePolicy().hasHeightForWidth())
        self.trainSlider.setSizePolicy(sizePolicy)
        self.trainSlider.setMaximum(100)
        self.trainSlider.setProperty("value", 80)
        self.trainSlider.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.trainSlider.setObjectName("trainSlider")
        self.verticalLayout_8.addWidget(self.trainSlider)
        self.trainLabel = QtWidgets.QLabel(parent=SettingsWidget)
        self.trainLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.trainLabel.setObjectName("trainLabel")
        self.verticalLayout_8.addWidget(self.trainLabel)
        ...
        self.validSlider = QtWidgets.QSlider(parent=SettingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.validSlider.sizePolicy().hasHeightForWidth())
        self.validSlider.setSizePolicy(sizePolicy)
        self.validSlider.setMaximum(100)
        self.validSlider.setProperty("value", 20)
        self.validSlider.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.validSlider.setObjectName("validSlider")
        self.verticalLayout_10.addWidget(self.validSlider)
        self.validLabel = QtWidgets.QLabel(parent=SettingsWidget)
        self.validLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.validLabel.setObjectName("validLabel")
        self.verticalLayout_10.addWidget(self.validLabel)
        ...
        self.testSlider = QtWidgets.QSlider(parent=SettingsWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.testSlider.sizePolicy().hasHeightForWidth())
        self.testSlider.setSizePolicy(sizePolicy)
        self.testSlider.setMaximum(100)
        self.testSlider.setOrientation(QtCore.Qt.Orientation.Vertical)
        self.testSlider.setObjectName("testSlider")
        self.verticalLayout_9.addWidget(self.testSlider)
        self.testLabel = QtWidgets.QLabel(parent=SettingsWidget)
        self.testLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.testLabel.setObjectName("testLabel")
        self.verticalLayout_9.addWidget(self.testLabel)
    ...
    def retranslateUi(self, SettingsWidget):
        ...
        self.outputFormat.setItemText(0, _translate("SettingsWidget", "YOLOv5/YOLOv8"))
        ...
        self.totImages.setText(_translate("SettingsWidget", "0"))
        self.labeledImages.setText(_translate("SettingsWidget", "0"))
        self.unlabeled.setText(_translate("SettingsWidget", "0"))
        ...
        self.trainLabel.setText(_translate("SettingsWidget", "80%"))
        self.label_12.setText(_translate("SettingsWidget", "valid"))
        self.validLabel.setText(_translate("SettingsWidget", "20%"))
        self.label_10.setText(_translate("SettingsWidget", "test"))
        self.testLabel.setText(_translate("SettingsWidget", "0%"))
